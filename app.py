...
CATALOGO = {
  ...
  "221402 - ASEGURAMIENTO METROLOGICO INDUSTRIAL": {
    "proyectos": {
      "2721554 - IMPLEMENTACION DE UN SISTEMA DE GESTION METROLOGICA PARA LOS PROCESOS DE PRODUCCION Y ASEGURAMIENTO DE LA CALIDAD EN UNA INDUSTRIA DE MANUFACTURA": {
        "nombre_completo": "2721554 - IMPLEMENTACION DE UN SISTEMA DE GESTION METROLOGICA PARA LOS PROCESOS DE PRODUCCION Y ASEGURAMIENTO DE LA CALIDAD EN UNA INDUSTRIA DE MANUFACTURA",
        "fases": {
          "ANÁLISIS": {
              ...
              },
              {
                ...
                "resultados": [
                  {"ra": "Alistar herramientas de tecnologías de la información y la comunicación (TIC), de acuerdo con las necesidades de procesamiento de información y comunicación.", "actividades": [
                    "No se conocen. Se requiere apoyo de instructores de esta competencia",
                  ]},
